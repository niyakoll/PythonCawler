...
def formatText(resultFileName,clientName)->str:
    ...
    cleanOldRecord(clientName=clientName,timeRange=clear_time_range) #clean old record older than 25 hours
    ...
    try:
        ...
        print(f"result_text_cleaning formatText read output record: {e}")
            ...
            if result :
                for post in result[:]:
                    ...
                    try:
                        ...
                        print(f"result_text_cleaning formatText read search result: {e}")
                    try:
                        ...
                        print(f"result_text_cleaning formatText formating text: {e}")
                    reply = post["replies"] or []
                    for comment in reply:
                        commentText = comment["text"]
                        commentTimeStamp = comment["published_on"]
                        commentTime = timestampConvert(commentTimeStamp)
...
def postList(resultFileName,clientName):
    ...
    try:
        ...
        print(f"result_text_cleaning postList: {e}")
